...
# download a tgz of pictures to our Pictures directory if it isn't already there - assumes you are online
test -f ~/Pictures/pics.tgz || wget -q -O ~/Pictures/pics.tgz http://zonzorp.net/pics.tgz

# unpack the downloaded tgzfile if it is there, then delete the tgzfile
